...
void Error_Handler(void)
{
  ...
  while (1)
  {
		...
		if(buttonState){
			...
			HAL_GPIO_WritePin(led_green_Pin |led_orange_Pin | led_red_Pin | led_blue_Pin,GPIO_PIN_SET);
				counter++;
				HAL_Delay(300);
			elseif{

				HAL_GPIO_WritePin(led_green_Pin | led_orange_Pin | led_red_Pin | led_blue_Pin);
  }
	elseif(counter%4==1){
	...
	elseif(counter%4==3){
		...
		HAL_GPIO_WritePin(GPIOD, led_green_Pin | led_orange_Pin|led_blue_Pin, GPIO_PIN_RESET);
	}
  elseif(counter4==0){
